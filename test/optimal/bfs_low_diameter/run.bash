...
do
    ...
    echo ./bfs_allfuse_low_diameter.bin  $data $src $blk $bfsp
    ./bfs_optimal_low_diameter.bin  $data $src $blk $bfsp &>> bfs_allfuse_low_diameter_"$file".log
   ...
   #echo "./sssp_allfuse_low_diameter.bin $data $src $blk  $ssspp"
    #./sssp_allfuse_low_diameter_compute_atomic.bin $data $src $blk  $ssspp &>> sssp_allfuse_low_diameter_compute_atomic_"$file".log
